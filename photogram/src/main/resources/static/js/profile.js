...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		$.ajax({
			...
			data: formData,
			contentType: false, // (ajax로 사진전송하려면)필수 : x-www-form-urlencoded로 파싱되는 것을 방지
			processData: false, // (ajax로 사진전송하려면)필수 : contentType을 false로 줬을 때 QuerryString 자동 설정됨. 해제
